...
const NOTICE_READ = 'notice/NOTICE_READ';
const NOTICE_READ_SUCCESS = 'notice/NOTICE_READ_SUCCESS';
const NOTICE_READ_FAILURE = 'notice/NOTICE_READ_FAILURE';
const NOTICE_READ_ONE = 'notice/NOTICE_READ_ONE';
const NOTICE_READ_ONE_SUCCESS = 'notice/NOTICE_READ_ONE_SUCCESS';
const NOTICE_READ_ONE_FAILURE = 'notice/NOTICE_READ_ONE_FAILURE';
const NOTICE_DELETE = 'notice/NOTICE_DELETE';
const NOTICE_DELETE_SUCCESS = 'notice/NOTICE_DELETE_SUCCESS';
const NOTICE_DELETE_FAILURE = 'notice/NOTICE_DELETE_FAILURE';
const NOTICE_DELETE_ONE = 'notice/NOTICE_DELETE';
const NOTICE_DELETE_ONE_SUCCESS = 'notice/NOTICE_DELETE_ONE_SUCCESS';
const NOTICE_DELETE_ONE_FAILURE = 'notice/NOTICE_DELETE_ONE_FAILURE';
